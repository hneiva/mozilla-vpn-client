...
CALL configure -static -opensource -release -no-dbus -no-feature-qdbus -confirm-license -strip -silent -nomake tests -make libs -no-sql-psql -qt-sqlite -skip qt3d -skip webengine -skip qtmultimedia -skip qtserialport -skip qtsensors -skip qtgamepad -skip qtwebchannel -skip qtandroidextras -feature-imageformat_png -iconv -qt-libpng -qt-zlib -openssl-linked -I %BUILDDIR%\include -L %BUILDDIR%\lib -prefix %BUILDDIR%
